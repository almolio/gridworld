...
from .train_policy_cfg import DQNCfg
from utils.helper_fcts import class_to_dict
...
class Policy():
    """Implement a parent class for all our policies."""
...
class DQN_Agent(Policy):
    ...
    def __init__(self, args,
                 ...
                 net_type='conv',
                 **kwargs):
        super(DQN_Agent, self).__init__(device)
...
class Policy2(Policy):
    """Dummy implementation of an actual policy we will train and put to test."""

    def __init__(self, num_inputs, num_outputs, layer_dims=[128,128,128], activation='elu', **kwargs):
        super(Policy2, self).__init__(num_inputs, num_outputs, layer_dims=[128,128,128], activation='elu', **kwargs)
